...
export const DocumentMagnifyingGlassIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m5.231 13.481L15 17.25m-4.5 4.5V18m-4.5-4.5H3.75m1.5-1.5h-1.5a3.375 3.375 0 0 1-3.375-3.375v-1.5c0-1.026.396-1.993 1.096-2.747m.431 10.996a7.47 7.47 0 0 1-5.431-5.431m0 0A7.5 7.5 0 1 1 11.25 3.75v1.5a3.375 3.375 0 0 0 3.375 3.375h1.5a3.375 3.375 0 0 0 3.375-3.375v-1.5a7.5 7.5 0 0 0-11.25-6.312" />
    </svg>
);
